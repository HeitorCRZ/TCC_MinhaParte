...
module.exports = class Funcionario {
    ...
    async getFuncionario(registrocpf) {
        ...
        console.log("registro ou cpf : " + registrocpf);        
        ...
        try {
            ...
            if (result.length === 1) {
                ...
                this._registro= funcionario.registro;
                ...
                console.log("registro : " + funcionario.registro);
                console.log("tipo : " + funcionario.TipoFuncionario_idTipoFuncionario);
                return true;
            }
            return false;
        } catch (error) {
